...
<h1 class="welcomeThankYou"> Welcome to the VIP List! </h1>
<h2 style="text-align: center;"> As a VIP list member, you will receive notifications about once a month with last-minute deals <br> (you may unsubscribe at any time if you no longer wish to be on the VIP list).</h2>
<?php header( "refresh:5;url=index.php" ); ?>
